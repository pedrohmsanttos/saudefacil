...
class DoctorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cfm' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'doctors_ibfk_1' => ['type' => 'foreign', 'columns' => ['unit_id'], 'references' => ['units', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'cfm' => 'Lorem ipsum dolor sit amet',
            'unit_id' => 1,
            'username' => 'Lorem ipsum dolor sit amet',
            'password' => 'Lorem ipsum dolor sit amet',
            'created' => '2016-07-01 10:09:29',
            'modified' => '2016-07-01 10:09:29'
        ],
    ];
}
